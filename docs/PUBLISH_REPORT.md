...
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/DeviceRegistry/SlotTable.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/FieldLWW/ColumnHLCStore.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/Loop/OutboxDrainDebouncer.swift`: 4 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/Outbox/OutboxStore.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/SideSchema.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/SyncEngine.swift`: 4 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/SyncRecord.swift`: 2 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/SyncTypes.swift`: 2 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKit/Tombstone.swift`: 1 line(s)
...
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitCloudKit/Engine/ApplyInbound.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitCloudKit/Engine/CloudKitStateActor.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitFederation/FederationIdentity.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitFederation/FederationSyncEngine.swift`: 5 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitFederation/HyperplaneFamilyExchange.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitFederation/Relay/LANRelayTLSConfig.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Sources/ConvergenceKitNone/ConvergenceKitNone.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/ApplyInboundAtomicityTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/CVK_ICLOUD_P4M5_PerfTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/CloudKitStubTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/LocalWriteColumnHLCGateTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/SkewIntegrationTests.swift`: 2 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/TokenStoreTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/TombstonePayloadRetentionTests.swift`: 2 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitCloudKitTests/ZoneSubscriptionTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitConformance/ConformancePlaceholder.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitConformance/FederationJSONConformanceTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/FedOutboxStoreFullWidthTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/FederationApplyInboundAtomicityTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/FederationPairingTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/FederationTombstoneGateLiveTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/FederationTombstoneRetentionTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/LAN/LANDiscoveryTests.swift`: 1 line(s)
- `packages/kits/ConvergenceKit/Tests/ConvergenceKitFederationTests/LocalWriteColumnHLCGateTests.swift`: 1 line(s)
...
- `packages/kits/ConvergenceKit/rust/src/federation.rs`: 60 line(s)
- `packages/kits/ConvergenceKit/rust/src/record.rs`: 2 line(s)
- `packages/kits/ConvergenceKit/rust/tests/federation_skew_tests.rs`: 2 line(s)
- `packages/kits/ConvergenceKit/rust/tests/federation_tests.rs`: 6 line(s)
- `packages/kits/ConvergenceKit/rust/tests/field_lww_engine_tests.rs`: 1 line(s)
- `packages/kits/ConvergenceKit/rust/tests/wire_format_tests.rs`: 2 line(s)
...
- `packages/kits/PersistenceKit/Sources/PersistenceKit/DatabaseInventory.swift`: 1 line(s)
...
- `packages/kits/PersistenceKit/Tests/PersistenceKitInMemoryTests/RowKeyDeterminismMoneyTests.swift`: 1 line(s)
...
- `packages/kits/PersistenceKit/Tests/PersistenceKitSQLiteTests/ChangeOriginSQLiteTests.swift`: 1 line(s)
...
- `packages/kits/PersistenceKit/Tests/PersistenceKitTests/RowKeyDerivationConformanceTests.swift`: 1 line(s)
- `packages/kits/PersistenceKit/rust/Cargo.toml`: 1 line(s)
...
- `packages/kits/PersistenceKit/rust/src/estate_migration.rs`: 7 line(s)
...
- `packages/kits/PersistenceKit/rust/src/layout_signature.rs`: 2 line(s)
- `packages/kits/PersistenceKit/rust/src/lib.rs`: 1 line(s)
- `packages/kits/PersistenceKit/rust/src/maintenance.rs`: 2 line(s)
...
- `packages/kits/PersistenceKit/rust/src/storage.rs`: 8 line(s)
- `packages/kits/PersistenceKit/rust/src/types.rs`: 5 line(s)
- `packages/kits/PersistenceKit/rust/tests/changed_columns_tests.rs`: 1 line(s)
